...
const responses = {
  ...
  continue: function (data) {
    this.status(STATUS.OFFICIAL.HTTP_CONTINUE);
    return checkData(this, data);
  },

  switchingProtocol: function (data) {
    this.status(STATUS.OFFICIAL.HTTP_SWITCHING_PROTOCOL);
    return checkData(this, data);
  },

  processing: function (data) {
    this.status(STATUS.OFFICIAL.HTTP_PROCESSING);
    return checkData(this, data);
  },

  earlyHint: function (data) {
    this.status(STATUS.OFFICIAL.HTTP_EARLY_HINT);
    return checkData(this, data);
  },
  */
  ...
  //   this.status(STATUS.UNOFFICIAL.HTTP_CHECKPOINT);
  //   return checkData(this, data);
  // },
